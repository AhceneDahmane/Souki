...
export default function Footer() {
  return (
    <footer className="relative border-t border-[#27272a] bg-[#0a0a0b]/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed max-w-xs">
              La plateforme SaaS qui connecte organisateurs, vendeurs et acheteurs autour des souks automobiles en Algérie.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-[#27272a] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-zinc-600">
            © {new Date().getFullYear()} Souki. Tous droits réservés.
          </p>
          <div className="flex items-center gap-4">
            {[
              ...
              <Link key={i} href={social.href} className="text-zinc-600 hover:text-amber-400 transition-colors">
